...
namespace Evolution.Environment.Life.Plants
{
    public class FloraManager
    {
        ...
        public void Initialise()
        {
            ...
            grasslandPlants.AddPlant(Plants.Clover);
            grasslandPlants.AddPlant(Plants.Flat);
            grasslandPlants.AddPlant(Plants.Spikey);
            grasslandPlants.AddPlant(Plants.Bush);
            grasslandPlants.AddPlant(Plants.Tree1);
