...
namespace Evolution.Environment.Life.Creatures.Legs
{
    ...
    public readonly struct LegModel
    {
        ...
        public LegModel(VertexArray s1, VertexArray s2, float length, float legDirection, Vector2 baseOffset, float legThickness)
        {
            Segment1 = s1;
            Segment2 = s2;
            Length = length;
        ...
        public LegModel Flip()
            => new LegModel(Segment1, Segment2, Length, -LegDirection, BaseOffset * new Vector2(-1, 1), LegThickness);
    }
}
